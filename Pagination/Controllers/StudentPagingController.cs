...
{
    public class StudentPagingController : Controller
    {
        ...
        // GET: StudentPaging/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: StudentPaging/Create
